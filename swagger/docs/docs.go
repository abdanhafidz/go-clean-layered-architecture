...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "402": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-models_AcademyPaymentTransaction"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-models_Academy"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-models_AcademyAssign"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/admin/academy/assign/{academy_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/admin/academy/assign/{id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-models_AcademyContent"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/admin/academy/contents/{id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/admin/academy/id/{id}/detail": {
            "get": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-models_AcademyMaterial"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-models_EmailVerification"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.SuccessResponse-models_AcademyPaymentTransaction": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.AcademyPaymentTransaction"
        ...
        "dto.SuccessResponse-models_EmailVerification": {
            "type": "object",
            "properties": {
                "data": {
